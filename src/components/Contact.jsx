      ...
      <motion.div initial={{ x: "-50vw" }} animate={{ x: 0 }}>
        <div className="w-screen top-[20vh] relative flex flex-col justify-center items-center mb-[250px]">
          ...
          <div className="contact-page flex justify-around items-center w-full">
            <div className="flex flex-col justify-around bg-white rounded-xl shadow-2xl my-8 border-2 w-[400px] h-[500px] text-center ring ring-[#725C71]">
              Address:
            ...
            <div className="bg-white rounded-xl shadow-2xl border-2 w-[400px] h-[500px] text-center ring ring-[#725C71]">
